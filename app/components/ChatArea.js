...
export default function ChatArea({ groupData }) {
  ...
  return (
    <div className={styles.chatContainer}>
      ...
      {/* Footer System Log */}
      <div className={styles.systemLog}>
        <span className={styles.logEntry}>Chain: MONAD TESTNET (10143)</span>
        <span className={styles.logEntry}>Settlement: ON-CHAIN | Protocol: DEBATE v3</span>
        <span className={styles.logEntry}>AI Engine: OpenAI | Agents: AUTONOMOUS</span>
      </div>
    </div>
  )
}
